...
## ΝΕΟ: Συνομιλία με AI
Μπορείτε να μιλήσετε για απορίες και καθοδήγηση με ένα AI βασισμένο σε όλα τα έγγραφα του οδηγού. Αν χρειάζεστε κάποια βοήθεια, μπορείτε να μιλήσετε με τον AI κάθε στιγμή. [Πατήστε εδώ (χρειάζεται σύνδεση σε google account)](https://aistudio.google.com/app/prompts?state=%7B%22ids%22:%5B%221unXDKPOaGjXC4q_TPakz7qTnqMEno3SG%22%5D,%22action%22:%22open%22,%22userId%22:%22103401117737940219919%22,%22resourceKeys%22:%7B%7D%7D&usp=sharing)
